...
<div id="team-single"
    style="background: linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 20%, rgba(0,0,0,1) 100%),  url('/wp-content/uploads/2022/10/corn-bw-1.png') no-repeat; background-size:cover;">
                ...
                <div id="team-single_right">
                    ...
                    <?php elseif (get_field('state') == 'none'): ?>
                        ...
                        <div id="team-single_info">
                            <p id="team-single_title"><?php the_field('title'); ?></p>
                            <div id="team-single_line-vert"></div><?php if (the_field('phone_number')): ?>
                                <p id="team-single_phone"><?php the_field('phone_number'); ?></p><?php endif; ?>
                        </div>
                                        ...
                                        <div class="team-short_grid-illinois">
                                            ...
                                            if (!empty($image)): ?>
                                                <img src="<?php echo esc_url($image['url']); ?>"
                                                    alt="<?php echo esc_attr($image['alt']); ?>" class="team-short_grid-headshot" />
                                            <?php endif; ?>
