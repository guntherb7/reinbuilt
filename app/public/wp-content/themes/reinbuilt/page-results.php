...
<div id="team"  style="background: linear-gradient(0deg, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 100%),  url('<?php echo $backgroundImg[0]; ?>') no-repeat; background-size:100vw; background-position:bottom -20px center;"> 
	...
	<div id="results_list" class=" container-full">
		...
		<div class="results-list" id="illinois-results" data-tab-content>
			<?php if( have_rows('illinois_results') ): ?>
				<?php while( have_rows('illinois_results') ): the_row(); 
		...
		<div class="results-list" id="wisconsin-results" data-tab-content>	
			<?php if( have_rows('wisconsin_results') ): ?>
				<?php while( have_rows('wisconsin_results') ): the_row(); 
