	...
	<section class="first-section">
		...
		<div class="swiper mySwiper">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<img src="/wp-content/uploads/2024/02/MountainView_MasterBedrmSittingArea-jpg.webp" loading="lazy"
	...
	<section>
		<div class="start-project--text">
			<div class="page--logo">
				...
				<img src="/wp-content/uploads/2024/03/REINBUILT_LOGO_LIGHT-GRAY.svg" width="275" height="42"
					loading="lazy" fetchpriority="low" class="light-icon"
					alt="Reinbuilt Luxury Homes Logo in Light Gray" />
			</div>
