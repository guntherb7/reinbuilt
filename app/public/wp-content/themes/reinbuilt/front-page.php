...
<div id="front-page">
    <?php if ( has_post_thumbnail() ) { ?>
        ...
        <div id="fp-hero" class="hero-bg-fade" style="background: linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 60%, rgba(0,0,0,0) 100%),  url('<?php echo $backgroundImg[0]; ?>') no-repeat; background-size:114vh; background-position:top right;">
        <?php } else { ?>
        <?php } ?>
            <div id="fp-hero_grid" class="container-full">
                <div id="fp-hero_right" >
                    <div id="fp-hero_right-container">
                        <?php $image = get_field('hero_image'); if( !empty( $image ) ): ?>
                ...
                <div id="fp-hero_left">    
                    ...
                    <?php  $link = get_field('link'); if( $link ): ?>
                        ...
                        ?>
                        <a class="btn btn-orange" href="<?php echo esc_url( $link_url ); ?>" ><?php echo esc_html( $link_title ); ?></a>
                        <?php endif; ?>
                    <?php endif; ?>
