...
<?php if ( has_post_thumbnail() ) { ?>
    ...
    <div id="about" class="hero-bg-fade" style="background: linear-gradient(-90deg, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 50%, rgba(0,0,0,1) 100%),  url('<?php echo $backgroundImg[0]; ?>') no-repeat; background-size:cover;">
    <?php } else { ?>
    <?php } ?>
    <div id="about_intro">
    ...
    <div id="about-masonry">
        <?php if( have_rows('masonry_layout') ): ?>
			<?php while( have_rows('masonry_layout') ): the_row(); 
...
<div id="contact-block">
	<div id="contact-block_content"><div id="contact-block_content">
		<h3 style="text-align: center;">Let’s Grow Together</h3>
<p style="text-align: center;">Our partners get more than just the country’s most efficient seed distributor, they get an entire system of growth support.</p>
