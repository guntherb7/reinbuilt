...
<?php if (has_post_thumbnail()) { ?>
	...
	<div id="team"
		style="background: linear-gradient(0deg, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 40%, rgba(0,0,0,1) 100%),  url('<?php echo $backgroundImg[0]; ?>') no-repeat; background-size:100vw; background-position:bottom -20px center;">
						...
						<?php if (get_field('state') == 'illinois'): ?>
							...
							<?php elseif (get_field('state') == 'wisconsin'): ?>
								...
								<?php elseif (get_field('state') == 'none'): ?>
									...
									<p class="team_grid-name">
										<?php the_title(); ?>
									</p>
									<span class="team_grid-title">
										<?php the_field('title'); ?>
									</span>
									<div class="team_grid-phone-container">
										<?php if (get_field('phone_number')): ?>
											<p class="team_grid-phone">
