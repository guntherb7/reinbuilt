...
<div id="products">   
            ...
            <div id="products_top" class="hero-bg-fade" style="background: linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 40%, rgba(0,0,0,1) 100%),  url('<?php echo $backgroundImg[0]; ?>') no-repeat; background-size:cover;">
       		<?php } else { ?>
			<?php } ?>
				<div id="products_hero" class="container-full">
					...
					<div id="products_hero-right">
						<h1 id="products_hero-intro" class="theme-h1"><?php echo $intro; ?></h1>
						<p id="products_hero-copy"><?php echo $copy; ?></p>
					</div>
				</div>
				...
				<?php while( have_rows('products') ): the_row(); 
					...
					<a href="<?php echo $link; ?>" class="products_tiles-grid">
						<div class="products_tiles-left">
							<img src="<?php echo esc_url($logo['url']); ?>" alt="<?php echo esc_attr($logo['alt']); ?>" class="products_tiles-logo img-responsive" />
						</div>
						<div class="products_tiles-right">
							<?php echo $copy; ?>
							<span class="products_tiles-link"><?php echo$linkText; ?></span>
						</div>
						</a>
				<?php endwhile; ?>
			</div>
